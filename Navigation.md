...
## 🎯 2.5 Create Key Vault Linked Service in ADF ⚙️
...
💡 **A. If you want to use Key Vault secret (Account Key) in Storage LS** 🛠️
...
💡 **B. Recommended modern approach — Keep using Managed Identity for Storage** 🛠️
